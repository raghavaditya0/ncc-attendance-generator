...
export default function Home() {
  ...
  const updateCadet = (id: number, field: keyof Omit<Cadet, "id">, value: string) => setCadets((current) => current.map((cadet) => cadet.id === id ? { ...cadet, [field]: value } : cadet));
